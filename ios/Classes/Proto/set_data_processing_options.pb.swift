...
struct FBSetDataProcessingOptionsRequest {
  ...
  enum OneOf_OptionalCountry: Equatable {
    case country(Int32)

  #if !swift(>=4.1)
    static func ==(lhs: FBSetDataProcessingOptionsRequest.OneOf_OptionalCountry, rhs: FBSetDataProcessingOptionsRequest.OneOf_OptionalCountry) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.country, .country): return {
        guard case .country(let l) = lhs, case .country(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      }
    }
  ...
  enum OneOf_OptionalState: Equatable {
    case state(Int32)

  #if !swift(>=4.1)
    static func ==(lhs: FBSetDataProcessingOptionsRequest.OneOf_OptionalState, rhs: FBSetDataProcessingOptionsRequest.OneOf_OptionalState) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension FBSetDataProcessingOptionsRequest: @unchecked Sendable {}
extension FBSetDataProcessingOptionsRequest.OneOf_OptionalCountry: @unchecked Sendable {}
extension FBSetDataProcessingOptionsRequest.OneOf_OptionalState: @unchecked Sendable {}
