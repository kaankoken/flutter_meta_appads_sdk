...
enum FBStandardEvents: SwiftProtobuf.Enum {
...
extension FBStandardEvents: CaseIterable {
...
enum FBStandardParameters: SwiftProtobuf.Enum {
  typealias RawValue = Int
...
extension FBStandardParameters: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
struct FBLogStandardEventMessageRequest {
...
extension FBStandardEvents: @unchecked Sendable {}
extension FBStandardParameters: @unchecked Sendable {}
extension FBLogStandardEventMessageRequest: @unchecked Sendable {}
extension FBDefaultParameter: @unchecked Sendable {}
